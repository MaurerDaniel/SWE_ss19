...
namespace MvvmLight2.ViewModel
{
    ...
    public class MainViewModel : ViewModelBase
    {
        ...
        private RelayCommand<string> _navigateCommand2;
            ...
            get
            {
                return _navigateCommand
                       ?? (_navigateCommand = new RelayCommand<string>(
                           p => _navigationService.NavigateTo(ViewModelLocator.FotographerListViewKey, p),
                           p => !string.IsNullOrEmpty(p)));
            }
        }

        public RelayCommand<string> NavigateCommand2
        {
            get
            {
                return _navigateCommand2
                       ?? (_navigateCommand2 = new RelayCommand<string>(
                           p => _navigationService.NavigateTo(ViewModelLocator.ThirdPageKey, p),
                           p => !string.IsNullOrEmpty(p)));
            }
        }
        ...
        private string _test = "Testen wir mal.";
